...
There is also a custom typst configuration in ```/bin``` that essentially allows me to run ```typst document_name``` and open an instance of nvim and sioyek to view the 
